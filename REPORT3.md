...
## Загальне завдання
[cite_start]Реалізувати алгоритм сортування чисел у списку двома способами: функціонально (конструктивний підхід)
[cite_start]та імперативно (деструктивний підхід).

## Варіант 3
[cite_start]**Алгоритм сортування обміном №2 (із використанням прапорця) за незменшенням**.
